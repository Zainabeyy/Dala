...
export default function SubsidiariesCard({
  ...
  return (
    <div className="pt-29.25 pb-10 px-7 bg-blue-light relative w-60 h-71.25">
      ...
      <div className="blueCard isolate">
        ...
        />
        {/* <div className="isolate size-2.5 bg-black rotate-45 absolute -right-1.25 top-0.5 -z-100" /> */}
        <div className="bg-blue-dark w-full h-full absolute top-0 left-0 rounded-bl-2xl rounded-br-2xl" />
      </div>
      <div className="isolate size-2.5 bg-black rotate-45 absolute right-5.75 -top-0.75 -z-100" />
